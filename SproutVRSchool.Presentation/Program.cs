...
bool IsSeedingDatabaseOnStartupDevelopment = miscConfigs.GetValue<bool?>("IsSeedingDatabaseOnStartupDevelopment") ?? false;
...
if (env.IsDevelopment())
{
    ...
    if (IsSeedingDatabaseOnStartupDevelopment)
    {
