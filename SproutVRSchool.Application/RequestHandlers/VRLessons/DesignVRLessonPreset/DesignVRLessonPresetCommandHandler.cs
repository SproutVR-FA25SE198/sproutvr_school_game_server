...
public sealed class DesignVRLessonPresetCommandHandler(
    IUnitOfWork uow,
    ILocalStorageService localStorageService,
    ILogger<DesignVRLessonPresetCommandHandler> logger
    ) : IRequestHandler<DesignVRLessonPresetCommand, Unit>
{
    public async Task<Unit> Handle(DesignVRLessonPresetCommand request, CancellationToken cancellationToken)
    {
