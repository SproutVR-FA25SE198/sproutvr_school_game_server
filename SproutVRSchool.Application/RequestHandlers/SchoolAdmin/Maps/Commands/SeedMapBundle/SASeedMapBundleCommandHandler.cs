...
public sealed class SASeedMapBundleCommandHandler : IRequestHandler<SASeedMapBundleCommand, SASeedMapBundleCommandResponseDto>
{
    // ================================
    // === Fields
    // ================================
    ...
    private readonly ILogger<SASeedMapBundleCommandHandler> _logger;

    // ================================
    // === Constructors
    // ================================

    public SASeedMapBundleCommandHandler(
        IHttpClientFactory httpClientFactory,
        IConfiguration configuration,
        IUnitOfWork unitOfWork,
        IServiceProvider serviceProvider,
        IDataSeeder fileSeeder,
        ILogger<SASeedMapBundleCommandHandler> logger
    )
    {
    ...
    public async Task<SASeedMapBundleCommandResponseDto> Handle(SASeedMapBundleCommand request, CancellationToken cancellationToken)
    {
